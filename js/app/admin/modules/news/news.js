...
import Article from 'js/app/admin/modules/news/article'
import ArticleModel from 'js/app/admin/modules/news/articleModel'
...
export default List.extend({
    defaults: {
        viewpath: '/js/app/admin/modules/news/views/',
